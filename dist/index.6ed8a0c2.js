...
},{"@forgjs/noframework":"ahxX2","./VM":"4l0QT","feather-icons":"hShU0"}],"ahxX2":[function(require,module,exports) {
...
const VM = (eventManager)=>{
    ...
    audioFiles.forEach((f, i)=>{
        audioFiles[i].audio.volume = 0;
    });
    eventManager.subscribe('toggle-mute', ()=>{
        if (audioFiles[0].audio.volume > 0) audioFiles.forEach((f, i)=>{
            audioFiles[i].audio.volume = 0;
        });
        else {
            audioFiles.forEach((f, i)=>{
                audioFiles[i].audio.volume = f.volume;
            });
    ...
    const flicker = ()=>{
        if (light.classList.contains('flicker')) return;
        light.classList.add('flicker');
        flickerSound.play();
        Array(10).fill().map((e, i)=>{
            setTimeout(()=>{
                if (light.classList.contains('flicker')) flickerSound.play();
            }, i * 50);
            return false;
        });
...
},{"@forgjs/noframework":"ahxX2"}],"hShU0":[function(require,module,exports) {
...
*/ module.exports = function(options, source) {
        ...
        /***/ "./node_modules/core-js/internals/native-weak-map.js": function(module, exports, __webpack_require__) {
            ...
            var WeakMap1 = global.WeakMap;
            module.exports = typeof WeakMap1 === 'function' && /native code/.test(nativeFunctionToString.call(WeakMap1));
        /***/ },
        ...
        /***/ "./src/icon.js": function(module, exports, __webpack_require__) {
            ...
            var Icon = function() {
                function Icon1(name, contents) {
                    var tags = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
                    _classCallCheck(this, Icon1);
                    this.name = name;
